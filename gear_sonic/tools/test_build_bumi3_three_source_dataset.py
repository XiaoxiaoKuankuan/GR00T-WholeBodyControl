...
def test_source_mjcf_gate_accepts_only_current_and_reviewed_history() -> None:
    """数据来源可使用当前 4340 或明确审核的历史指纹，但拒绝任意未知 MJCF。"""
    ...
    assert build_tool._require_compatible_source_mjcf(
        "旧 SONIC 数据", build_tool.LEGACY_SONIC_MJCF_SHA256
    ) == build_tool.LEGACY_SONIC_MJCF_SHA256
